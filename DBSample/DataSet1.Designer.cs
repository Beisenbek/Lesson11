...
namespace DBSample {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow AddUserRow(int Id, string Name, string Surname, double Cash) {
        ...
        public partial class UserRow : global::System.Data.DataRow {
            ...
            public double Cash {
                get {
                    return ((double)(this[this.tableUser.CashColumn]));
                }
                set {
                    this[this.tableUser.CashColumn] = value;
                }
            }
        }
...
namespace DBSample.DataSet1TableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [User] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND" +
                " ([Surname] = @Original_Surname) AND ([Cash] = @Original_Cash))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [User] ([Id], [Name], [Surname], [Cash]) VALUES (@Id, @Name, @Surname" +
                ", @Cash);\r\nSELECT Id, Name, Surname, Cash FROM [User] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [User] SET [Id] = @Id, [Name] = @Name, [Surname] = @Surname, [Cash] = @Cash WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Cash] = @Original_Cash));
SELECT Id, Name, Surname, Cash FROM [User] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DBSample.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Surname, double Original_Cash) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((double)(Original_Cash));
        ...
        public virtual int Insert(int Id, string Name, string Surname, double Cash) {
        ...
        public virtual int Update(int Id, string Name, string Surname, double Cash, int Original_Id, string Original_Name, string Original_Surname, double Original_Cash) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((double)(Original_Cash));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, double Cash, int Original_Id, string Original_Name, string Original_Surname, double Original_Cash) {
            return this.Update(Original_Id, Name, Surname, Cash, Original_Id, Original_Name, Original_Surname, Original_Cash);
        }
    }
